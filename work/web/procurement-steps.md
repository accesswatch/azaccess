---
layout: default
breadcrumb_parent: "Procurement"
breadcrumb_parent_url: procurement.html
title: Accessible Procurement Process
summary: Ensuring technology purchases meet accessibility requirements before contract signing.
owner: Procurement + Accessibility PMO
...
sources:
  ...
  - University of Washington Accessible Technology Procurement — https://www.washington.edu/accessibility/procurement/
  - UW Digital Accessibility Checklist — https://www.washington.edu/accesstech/checklist/
  - Section508.gov Buy Accessible — https://www.section508.gov/buy/
...
See [Detailed VPAT Review Guide](vpat-review.html) for more.
...
Accessibility should be considered at each step of the procurement process. This framework, adapted from the [University of Washington's Accessible Technology procurement model](https://www.washington.edu/accessibility/procurement/), provides a structured approach.

> **Key Principle:** Those responsible for making decisions about which products to procure must consider accessibility as one of the criteria for acquisition. This is especially critical for enterprise-level systems and other technologies that affect a large number of students, faculty, and/or staff.
> — Adapted from University of Washington Accessible Technology
...
- ACRs are typically created from a [Voluntary Product Accessibility Template (VPAT)](https://www.itic.org/policy/accessibility/vpat)
...
> **Quick Keyboard Test:** One easy test that anyone can perform without specialized tools: **Test the product with a keyboard**. Anything accessible with a mouse should also be accessible with keyboard alone. If a product fails the keyboard test, this is a strong indicator of other accessibility problems.
...
Before finalizing any technology purchase, conduct this simple but revealing test. Based on the [UW Accessible Technology keyboard checklist](https://www.washington.edu/accesstech/checklist/keyboard/).
...
This checklist framework is adapted from the [University of Washington's Digital Accessibility Checklist](https://www.washington.edu/accesstech/checklist/), which organizes checkpoints by technology type and impact.
...
*Checklist framework adapted from [University of Washington Accessible Technology](https://www.washington.edu/accesstech/checklist/), used with attribution under their public educational mission. The UW checklist is based on W3C's Web Content Accessibility Guidelines (WCAG) 2.1.*
...
### Primary Sources
- **[University of Washington Accessible Technology: Procurement](https://www.washington.edu/accessibility/procurement/)** — The three-step framework and validation questions are adapted from UW's comprehensive procurement model.
- **[University of Washington Digital Accessibility Checklist](https://www.washington.edu/accesstech/checklist/)** — The checkpoint framework organized by technology type.
- **[UW DO-IT (Disabilities, Opportunities, Internetworking, and Technology)](https://doit.uw.edu/)** — Resources on universal design and inclusive technology in higher education.

### Additional Authoritative Sources
- [Section508.gov: Buy Accessible](https://www.section508.gov/buy/) — Federal IT accessibility procurement guidance
- [Minnesota IT Services: Accessible IT Procurement](https://mn.gov/mnit/about-mnit/accessibility/procurement/) — State-level procurement framework
- [ITI VPAT Templates](https://www.itic.org/policy/accessibility/vpat) — Official Voluntary Product Accessibility Template
- [W3C WCAG 2.2](https://www.w3.org/WAI/standards-guidelines/wcag/) — The technical standard for web accessibility
...
- [How to Read a VPAT](vpat-review.html)
- [Vendor Accessibility FAQ](vendor-faq.html)
- [Governance Charter](governance-charter.html)
